...
def ejercicio1():
    ...
    with open('Ejercicio 1', 'w', encoding='utf-8') as archivo:
        archivo.write(f"El nombre mas largo es: {nombrelargo}, tiene {largo} caracteres.")
    return nombres
...
def ejercicio2():
    ...
    with open('Ejercicio 2', 'w', encoding='utf-8') as archivo:
        archivo.write(f"Entre todos los nombres hay {cantVocales} vocales")
...
def ejercicio3():
    ...
    with open('Ejercicio 3', 'w', encoding='utf-8') as archivo:
        archivo.write(nuevos_numeros)
...
def ejercicio4():
    ...
    with open('Ejercicio 4', 'w', encoding='utf-8') as archivo:
        archivo.write(f"Mano actual: {Mano}")
